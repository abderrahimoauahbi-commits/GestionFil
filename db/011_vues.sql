...
WITH horizon AS (
    ...
    SELECT bm.code_reference,
     ...
     GROUP BY bm.code_reference, bm.rang_mois
),
premier_mois AS (
...
GROUP BY hp.code_reference, 3, hp.code_devise;
...
GROUP BY rc.code_fournisseur, 3;
...
FROM v_recette_calculee rc
LEFT JOIN v_stock_disponible sd ON sd.code_reference = rc.code_reference
GROUP BY rc.code_qualite, rc.code_role;
