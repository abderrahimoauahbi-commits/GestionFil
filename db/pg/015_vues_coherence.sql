-- Porte automatiquement depuis db/015_vues_coherence.sql par pg/porter_vues.py.
...
DROP VIEW IF EXISTS v_coherence_recette CASCADE;
...
DROP VIEW IF EXISTS v_risque_sourcing CASCADE;
