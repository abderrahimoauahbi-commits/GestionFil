-- Porte automatiquement depuis db/016_controles_classeur.sql par pg/porter_vues.py.
...
DROP VIEW IF EXISTS v_ctl_c30 CASCADE;
...
DROP VIEW IF EXISTS v_ctl_c31 CASCADE;
         ...
         SELECT 1
          ...
          WHERE lm.code_reference = lr.code_reference
            ...
            AND (lr.lot_fournisseur IS NULL
                 OR lm.lot_fournisseur IS NOT DISTINCT FROM lr.lot_fournisseur));
...
DROP VIEW IF EXISTS v_ctl_c32 CASCADE;
